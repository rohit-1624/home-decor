...
const Home = () => {
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
    {/* Title Section - spans full width on mobile */}
    <div className="col-span-1 sm:col-span-2 md:col-span-1 flex flex-col items-center gap-4">
      ...
      <p className="text-gray-700 text-sm max-w-xs">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus laboriosam aliquid, sit soluta officia tempore.
      </p>
